...
% [DRAFT_AFTER_M5_COST] populated once results/ablation_cost_function.parquet
% lands.

\paragraph{Synthetic topology ablation.}
% [DRAFT_AFTER_M5_SYNTH] populated once results/ablation_synthetic_topology.parquet
% lands.
